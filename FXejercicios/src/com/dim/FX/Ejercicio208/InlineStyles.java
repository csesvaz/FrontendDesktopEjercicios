package com.dim.FX.Ejercicio208;
...
noBtn.setStyle("-fx-text-fill: green; -fx-font-weight: bold;");
Button openBtn = new Button("Open");
Button saveBtn = new Button("Save");
Button closeBtn = new Button("Close");
closeBtn.setStyle("-fx-text-fill: yellow; -fx-font-weight: bold;");
...
root.setStyle("-fx-border-width: 10.0; -fx-border-color: red;");
