package com.dim.FX.Ejercicio236;
...
StackPane transparentRectOverText = createStackPane("Hello", 0.5, 
false);
StackPane rectOverBigText = createStackPane("A bigger text", 1.0, 
false);
...
HBox root = new HBox(textOverRect,
		...
		public StackPane createStackPane(String str, double rectOpacity, boolean 
		rectFirst) {
