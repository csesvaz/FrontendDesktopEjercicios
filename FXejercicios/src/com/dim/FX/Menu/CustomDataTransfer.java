...
public CustomDataTransfer(Stage escenario) {
...
escenariomodal.setTitle("Drag-and-Drop Test");
escenariomodal.show();
 ...
 Label msgLbl = new Label("Select one or more items from a list, " + "drag and drop them to another list");
